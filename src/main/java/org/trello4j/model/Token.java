...
public class Token extends TrelloObject {
    ...
    public boolean equals(Object o) {
        ...
        Token token = (Token) o;
        return Objects.equals(idMember, token.idMember) &&
                Objects.equals(dateCreated, token.dateCreated) &&
                Objects.equals(dateExpires, token.dateExpires) &&
                Objects.equals(permissions, token.permissions);
    }

    @Override
    public int hashCode() {

        return Objects.hash(idMember, dateCreated, dateExpires, permissions);
    }
